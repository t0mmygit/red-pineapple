import { APIEmbedField, Client, EmbedBuilder, inlineCode, RestOrArray, TextChannel, userMention } from 'discord.js';
...
export async function logEvent(title: string, description: string, guild: string, metadata?: Metadata, color: number = COLORS.INFO): Promise<void> {
    if (!logChannel) {
